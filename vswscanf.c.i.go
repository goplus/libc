...
func wstring_read_cgo18_vswscanf(f *struct__IO_FILE, buf *uint8, len uint64) uint64 {
...
func vswscanf(s *uint32, fmt *uint32, ap []interface {
	...
	var buf [256]uint8
	var f struct__IO_FILE = struct__IO_FILE{0, nil, nil, nil, nil, nil, nil, nil, wstring_read_cgo18_vswscanf, nil, nil, (*uint8)(unsafe.Pointer(&buf)), 256, nil, nil, 0, 0, 0, 0, -1, 0, unsafe.Pointer(s), 0, nil, nil, nil, 0, 0, nil, nil, nil}
