...
func sn_write_cgo707(f *struct__IO_FILE, s *uint8, l uint64) uint64 {
...
func Vsnprintf(s *int8, n uint64, fmt *int8, ap []interface {
	...
	var f struct__IO_FILE = struct__IO_FILE{0, nil, nil, nil, nil, nil, nil, nil, nil, sn_write_cgo707, nil, (*uint8)(unsafe.Pointer(&buf)), 0, nil, nil, 0, 0, 0, 0, -1, -1, unsafe.Pointer(&c), 0, nil, nil, nil, 0, 0, nil, nil, nil}
