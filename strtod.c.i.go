...
func _cgos_strtox__strtod(s *int8, p **int8, prec int32) float64 {
...
func Strtof(s *int8, p **int8) float32 {
	return float32(_cgos_strtox__strtod(s, p, int32(0)))
}
func Strtod(s *int8, p **int8) float64 {
	return float64(_cgos_strtox__strtod(s, p, int32(1)))
}
func Strtold(s *int8, p **int8) float64 {
	return _cgos_strtox__strtod(s, p, int32(2))
}
