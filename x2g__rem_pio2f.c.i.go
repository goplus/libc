...
var toint_cgos____rem_pio2f float64 = 1.5 / 2.2204460492503131e-16
var pio4_cgos____rem_pio2f float64 = 0.78539818525314331
var invpio2_cgos____rem_pio2f float64 = 0.63661977236758138
var pio2_1_cgos____rem_pio2f float64 = 1.5707963109016418
var pio2_1t_cgos____rem_pio2f float64 = 1.5893254773528196e-8
...
func __rem_pio2f(x float32, y *float64) int32 {
	...
	if ix < uint32(1305022427) {
		fn = float64(x)*invpio2_cgos____rem_pio2f + toint_cgos____rem_pio2f - toint_cgos____rem_pio2f
		n = int32(fn)
		*y = float64(x) - fn*pio2_1_cgos____rem_pio2f - fn*pio2_1t_cgos____rem_pio2f
		if func() int64 {
			if *y < -pio4_cgos____rem_pio2f {
				return 1
			} else {
				return 0
			}
