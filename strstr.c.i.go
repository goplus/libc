...
func twobyte_strstr_cgos__strstr(h *uint8, n *uint8) *int8 {
...
func threebyte_strstr_cgos__strstr(h *uint8, n *uint8) *int8 {
...
func fourbyte_strstr_cgos__strstr(h *uint8, n *uint8) *int8 {
...
func twoway_strstr_cgos__strstr(h *uint8, n *uint8) *int8 {
	var z *uint8
	var l uint64
	var ip uint64
	var jp uint64
...
func Strstr(h *int8, n *int8) *int8 {
	...
	if !(*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(n)) + uintptr(int32(2)))) != 0) {
		return twobyte_strstr_cgos__strstr((*uint8)(unsafe.Pointer(h)), (*uint8)(unsafe.Pointer(n)))
	}
	...
	if !(*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(n)) + uintptr(int32(3)))) != 0) {
		return threebyte_strstr_cgos__strstr((*uint8)(unsafe.Pointer(h)), (*uint8)(unsafe.Pointer(n)))
	}
	...
	if !(*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer(n)) + uintptr(int32(4)))) != 0) {
		return fourbyte_strstr_cgos__strstr((*uint8)(unsafe.Pointer(h)), (*uint8)(unsafe.Pointer(n)))
	}
	return twoway_strstr_cgos__strstr((*uint8)(unsafe.Pointer(h)), (*uint8)(unsafe.Pointer(n)))
}
