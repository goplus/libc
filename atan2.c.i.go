...
var pi_cgos__atan2 float64 = 3.1415926535897931
var pi_lo_cgos__atan2 float64 = 1.2246467991473532e-16
...
func Atan2(y float64, x float64) float64 {
	...
	if ix|lx == uint32(0) {
		return func() float64 {
			if m&uint32(1) != 0 {
				return -pi_cgos__atan2 / float64(int32(2))
			} else {
				return pi_cgos__atan2 / float64(int32(2))
			}
		}()
	...
	if ix == uint32(2146435072) {
		if iy == uint32(2146435072) {
			switch m {
			case uint32(0):
				return pi_cgos__atan2 / float64(int32(4))
			case uint32(1):
				return -pi_cgos__atan2 / float64(int32(4))
			case uint32(2):
				return float64(int32(3)) * pi_cgos__atan2 / float64(int32(4))
			case uint32(3):
				return float64(-3) * pi_cgos__atan2 / float64(int32(4))
			}
		} else {
			switch m {
			case uint32(0):
	...
	case uint32(1):
		return -z
	case uint32(2):
		return pi_cgos__atan2 - (z - pi_lo_cgos__atan2)
	default:
		return z - pi_lo_cgos__atan2 - pi_cgos__atan2
	}
	return 0
}
