...
func _cgos_string_read__vsscanf(f *struct__IO_FILE, buf *uint8, len uint64) uint64 {
...
func Vsscanf(s *int8, fmt *int8, ap []interface {
	...
	var f struct__IO_FILE = struct__IO_FILE{0, nil, nil, nil, nil, nil, nil, nil, _cgos_string_read__vsscanf, nil, nil, (*uint8)(unsafe.Pointer(s)), 0, nil, nil, 0, 0, 0, 0, -1, 0, unsafe.Pointer(s), 0, nil, nil, nil, 0, 0, nil, nil, nil}
