...
func __mo_lookup(p unsafe.Pointer, size uint64, s *int8) *int8 {
	...
	t /= uint32(4)
	for {
		var ol uint32 = swapc_cgo385(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(mo)) + uintptr(o+uint32(2)*(b+n/uint32(2)))*4)), sw)
		var os uint32 = swapc_cgo385(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(mo)) + uintptr(o+uint32(2)*(b+n/uint32(2))+uint32(1))*4)), sw)
		...
		if !(sign != 0) {
			var tl uint32 = swapc_cgo385(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(mo)) + uintptr(t+uint32(2)*(b+n/uint32(2)))*4)), sw)
			var ts uint32 = swapc_cgo385(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer(mo)) + uintptr(t+uint32(2)*(b+n/uint32(2))+uint32(1))*4)), sw)
