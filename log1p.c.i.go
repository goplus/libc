...
var ln2_hi_cgos__log1p float64 = 0.69314718036912382
var ln2_lo_cgos__log1p float64 = 1.9082149292705877e-10
var Lg1_cgos__log1p float64 = 0.66666666666667351
var Lg2_cgos__log1p float64 = 0.39999999999409419
var Lg3_cgos__log1p float64 = 0.28571428743662391
var Lg4_cgos__log1p float64 = 0.22222198432149784
var Lg5_cgos__log1p float64 = 0.1818357216161805
var Lg6_cgos__log1p float64 = 0.15313837699209373
var Lg7_cgos__log1p float64 = 0.14798198605116586
...
func Log1p(x float64) float64 {
	...
	z = s * s
	w = z * z
	t1 = w * (Lg2_cgos__log1p + w*(Lg4_cgos__log1p+w*Lg6_cgos__log1p))
	t2 = z * (Lg1_cgos__log1p + w*(Lg3_cgos__log1p+w*(Lg5_cgos__log1p+w*Lg7_cgos__log1p)))
	R = t2 + t1
	dk = float64(k)
	return s*(hfsq+R) + (dk*ln2_lo_cgos__log1p + c) - hfsq + f + dk*ln2_hi_cgos__log1p
}
