...
type errmsgstr_t_cgos__strerror struct {
	str0               [21]int8
	strEILSEQ          [22]int8
	strEDOM            [13]int8
	strERANGE          [25]int8
...
func __strerror_l(e int32, loc *struct___locale_struct) *int8 {
	...
	s = (*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&errmsgstr_cgos__strerror)))) + uintptr(int32(*(*uint16)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint16)(unsafe.Pointer(&errmsgidx_cgos__strerror)))) + uintptr(e)*2))))))
