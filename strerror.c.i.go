...
type struct_errmsgstr_t struct {
	str0               [21]int8
	strEILSEQ          [22]int8
	strEDOM            [13]int8
	strERANGE          [25]int8
...
func __strerror_l(e int32, loc *struct___locale_struct) *int8 {
	...
	s = (*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&errmsgstr_cgo56)))) + uintptr(int32(*(*uint16)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint16)(unsafe.Pointer(&errmsgidx_cgo57)))) + uintptr(e)*2))))))
...
func Strerror(e int32) *int8 {
	return __strerror_l(e, (*struct___pthread)(unsafe.Pointer(uintptr(__get_tp()-16-uint64(0)))).locale)
}
