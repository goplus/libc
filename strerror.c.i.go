...
func __strerror_l(e int32, loc *struct___locale_struct) *int8 {
	...
	s = (*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&errmsgstr_cgo192)))) + uintptr(int32(*(*uint16)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint16)(unsafe.Pointer(&errmsgidx_cgo193)))) + uintptr(e)*2))))))
