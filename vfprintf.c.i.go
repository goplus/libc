...
func fmt_fp_cgo742(f *struct__IO_FILE, y float64, w int32, p int32, fl int32, t int32) int32 {
	...
	if !(func() int32 {
		...
		pad_cgo737(f, int8(' '), w, 3+pl, int32(uint32(fl)&4294901759))
		out_cgo736(f, prefix, uint64(pl))
		out_cgo736(f, s, uint64(3))
		pad_cgo737(f, int8(' '), w, 3+pl, int32(uint32(fl)^1<<('-'-' ')))
		return func() int32 {
			if w > 3+pl {
				return w
			} else {
		...
		*func() (_cgo_ret *int8) {
		...
		for {
			...
			*func() (_cgo_ret *int8) {
				...
				*(*uintptr)(unsafe.Pointer(_cgo_addr))++
				return
			}() = int8(int32(*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&xdigits_cgo738)))) + uintptr(x)))) | t&32)
		...
		out_cgo736(f, prefix, uint64(pl))
		pad_cgo737(f, int8('0'), w, pl+l, int32(uint32(fl)^1<<('0'-' ')))
		out_cgo736(f, (*int8)(unsafe.Pointer(&buf)), uint64(uintptr(unsafe.Pointer(s))-uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&buf))))))
		pad_cgo737(f, int8('0'), int32(int64(l)-int64(uintptr(unsafe.Pointer(ebuf))-uintptr(unsafe.Pointer(estr)))-int64(uintptr(unsafe.Pointer(s))-uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&buf)))))), 0, 0)
		out_cgo736(f, estr, uint64(uintptr(unsafe.Pointer(ebuf))-uintptr(unsafe.Pointer(estr))))
		pad_cgo737(f, int8(' '), w, pl+l, int32(uint32(fl)^1<<('-'-' ')))
		return func() int32 {
			if w > pl+l {
				return w
			} else {
	...
	if t|32 == 'f' {
		...
		for d = a; uintptr(unsafe.Pointer(d)) <= uintptr(unsafe.Pointer(r)); *(*uintptr)(unsafe.Pointer(&d)) += 4 {
			var s *int8 = fmt_u_cgo741(uint64(*d), (*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&buf))))+uintptr(9))))
			if uintptr(unsafe.Pointer(d)) != uintptr(unsafe.Pointer(a)) {
			...
			out_cgo736(f, s, uint64(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&buf))))+uintptr(9)))))-uintptr(unsafe.Pointer(s))))
		}
		if p != 0 || uint32(fl)&(1<<('#'-' ')) != 0 {
...
func printf_core_cgo744(f *struct__IO_FILE, fmt *int8, ap *[]interface {
	...
	_cgol_17:
		...
		pad_cgo737(f, int8(' '), w, p, int32(fl^1<<('-'-' ')))
		l = func() int32 {
			if w > p {
				return w
			} else {
	...
	_cgol_11:
		...
		out_cgo736(f, prefix, uint64(pl))
		pad_cgo737(f, int8('0'), w, pl+p, int32(fl^1<<('0'-' ')))
		pad_cgo737(f, int8('0'), p, int32(uintptr(unsafe.Pointer(z))-uintptr(unsafe.Pointer(a))), 0)
		out_cgo736(f, a, uint64(uintptr(unsafe.Pointer(z))-uintptr(unsafe.Pointer(a))))
		pad_cgo737(f, int8(' '), w, pl+p, int32(fl^1<<('-'-' ')))
		l = w
	}
	if f != nil {
		return cnt
...
func Vfprintf(f *struct__IO_FILE, fmt *int8, ap []interface {
	...
	var ret int32
	ap2 = ap
	if printf_core_cgo744(nil, fmt, &ap2, (*union_arg)(unsafe.Pointer(&nl_arg)), (*int32)(unsafe.Pointer(&nl_type))) < 0 {
		return int32(-1)
	}
