...
func checkseed(seed uint32, x *int64) {
	...
	if _cgos_chkmissing_random(x) != 0 {
		common.T_printf((*int8)(unsafe.Pointer(&[102]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'x', 'u', 's', 'h', 'i', 'w', 'e', 'i', '/', 'w', 'o', 'r', 'k', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '5', '0', ':', ' ', 'w', 'e', 'a', 'k', ' ', 's', 'e', 'e', 'd', ' ', '%', 'd', ',', ' ', 'm', 'i', 's', 's', 'i', 'n', 'g', ' ', 'p', 'a', 't', 't', 'e', 'r', 'n', ' ', 'i', 'n', ' ', 'l', 'o', 'w', ' ', 'b', 'i', 't', 's', '\n', '\x00'})), seed)
	}
	if _cgos_chkrepeat_random(x) != 0 {
		common.T_printf((*int8)(unsafe.Pointer(&[88]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'x', 'u', 's', 'h', 'i', 'w', 'e', 'i', '/', 'w', 'o', 'r', 'k', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '5', '2', ':', ' ', 'w', 'e', 'a', 'k', ' ', 's', 'e', 'e', 'd', ' ', '%', 'd', ',', ' ', 'e', 'x', 'a', 'c', 't', ' ', 'r', 'e', 'p', 'e', 'a', 't', 's', '\n', '\x00'})), seed)
	}
	if _cgos_chkones_random(x) != 0 {
		common.T_printf((*int8)(unsafe.Pointer(&[93]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'x', 'u', 's', 'h', 'i', 'w', 'e', 'i', '/', 'w', 'o', 'r', 'k', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '5', '4', ':', ' ', 'w', 'e', 'a', 'k', ' ', 's', 'e', 'e', 'd', ' ', '%', 'd', ',', ' ', 'o', 'r', ' ', 'p', 'a', 't', 't', 'e', 'r', 'n', ':', ' ', '0', 'x', '%', '0', '8', 'x', '\n', '\x00'})), seed, _cgos_orx_random)
	}
}
	...
	for i = int32(0); i < int32(100); i++ {
		if *(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer((*int64)(unsafe.Pointer(&x)))) + uintptr(i)*8)) != func() (_cgo_ret int64) {
			...
			*_cgo_addr = libc.Random()
			...
			common.T_printf((*int8)(unsafe.Pointer(&[119]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'x', 'u', 's', 'h', 'i', 'w', 'e', 'i', '/', 'w', 'o', 'r', 'k', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '7', '1', ':', ' ', 'i', 'n', 'i', 't', 's', 't', 'a', 't', 'e', '(', '1', ')', ' ', 'i', 's', ' ', 'n', 'o', 't', ' ', 'd', 'e', 'f', 'a', 'u', 'l', 't', ':', ' ', '(', '%', 'd', ')', ' ', 'd', 'e', 'f', 'a', 'u', 'l', 't', ':', ' ', '%', 'l', 'd', ',', ' ', 's', 'e', 'e', 'd', '1', ':', ' ', '%', 'l', 'd', '\n', '\x00'})), i, *(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer((*int64)(unsafe.Pointer(&x)))) + uintptr(i)*8)), y)
		}
	}
	...
	for i = int32(0); i < int32(100); i++ {
		if *(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer((*int64)(unsafe.Pointer(&x)))) + uintptr(i)*8)) != func() (_cgo_ret int64) {
			...
			*_cgo_addr = libc.Random()
			...
			common.T_printf((*int8)(unsafe.Pointer(&[117]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'x', 'u', 's', 'h', 'i', 'w', 'e', 'i', '/', 'w', 'o', 'r', 'k', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '8', '2', ':', ' ', 's', 'r', 'a', 'n', 'd', 'o', 'm', '(', '1', ')', ' ', 'i', 's', ' ', 'n', 'o', 't', ' ', 'd', 'e', 'f', 'a', 'u', 'l', 't', ':', ' ', '(', '%', 'd', ')', ' ', 'd', 'e', 'f', 'a', 'u', 'l', 't', ':', ' ', '%', 'l', 'd', ',', ' ', 's', 'e', 'e', 'd', '1', ':', ' ', '%', 'l', 'd', '\n', '\x00'})), i, *(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer((*int64)(unsafe.Pointer(&x)))) + uintptr(i)*8)), y)
		}
	}
