...
func checkseed(seed uint32, x *int64) {
	...
	if _cgos_chkmissing_random(x) != 0 {
		common.T_printf((*int8)(unsafe.Pointer(&[99]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'v', 'f', 'c', '/', 'g', 'o', 'p', 'l', 'u', 's', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '5', '0', ':', ' ', 'w', 'e', 'a', 'k', ' ', 's', 'e', 'e', 'd', ' ', '%', 'd', ',', ' ', 'm', 'i', 's', 's', 'i', 'n', 'g', ' ', 'p', 'a', 't', 't', 'e', 'r', 'n', ' ', 'i', 'n', ' ', 'l', 'o', 'w', ' ', 'b', 'i', 't', 's', '\n', '\x00'})), seed)
	}
	if _cgos_chkrepeat_random(x) != 0 {
		common.T_printf((*int8)(unsafe.Pointer(&[85]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'v', 'f', 'c', '/', 'g', 'o', 'p', 'l', 'u', 's', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '5', '2', ':', ' ', 'w', 'e', 'a', 'k', ' ', 's', 'e', 'e', 'd', ' ', '%', 'd', ',', ' ', 'e', 'x', 'a', 'c', 't', ' ', 'r', 'e', 'p', 'e', 'a', 't', 's', '\n', '\x00'})), seed)
	}
	if _cgos_chkones_random(x) != 0 {
		common.T_printf((*int8)(unsafe.Pointer(&[90]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'v', 'f', 'c', '/', 'g', 'o', 'p', 'l', 'u', 's', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '5', '4', ':', ' ', 'w', 'e', 'a', 'k', ' ', 's', 'e', 'e', 'd', ' ', '%', 'd', ',', ' ', 'o', 'r', ' ', 'p', 'a', 't', 't', 'e', 'r', 'n', ':', ' ', '0', 'x', '%', '0', '8', 'x', '\n', '\x00'})), seed, _cgos_orx_random)
	}
}
	...
	for i = int32(0); i < int32(100); i++ {
		if *(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer((*int64)(unsafe.Pointer(&x)))) + uintptr(i)*8)) != func() (_cgo_ret int64) {
			...
			*_cgo_addr = libc.Random()
			...
			common.T_printf((*int8)(unsafe.Pointer(&[116]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'v', 'f', 'c', '/', 'g', 'o', 'p', 'l', 'u', 's', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '7', '1', ':', ' ', 'i', 'n', 'i', 't', 's', 't', 'a', 't', 'e', '(', '1', ')', ' ', 'i', 's', ' ', 'n', 'o', 't', ' ', 'd', 'e', 'f', 'a', 'u', 'l', 't', ':', ' ', '(', '%', 'd', ')', ' ', 'd', 'e', 'f', 'a', 'u', 'l', 't', ':', ' ', '%', 'l', 'd', ',', ' ', 's', 'e', 'e', 'd', '1', ':', ' ', '%', 'l', 'd', '\n', '\x00'})), i, *(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer((*int64)(unsafe.Pointer(&x)))) + uintptr(i)*8)), y)
		}
	}
	for i = int32(0); i < int32(10); i++ {
		...
		if z != func() (_cgo_ret int64) {
			...
			*_cgo_addr = libc.Random()
			...
			common.T_printf((*int8)(unsafe.Pointer(&[100]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'v', 'f', 'c', '/', 'g', 'o', 'p', 'l', 'u', 's', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '7', '6', ':', ' ', 's', 'e', 't', 's', 't', 'a', 't', 'e', ' ', 'f', 'a', 'i', 'l', 'e', 'd', ' ', '(', '%', 'd', ')', ' ', 'o', 'r', 'i', 'g', ':', ' ', '%', 'l', 'd', ',', ' ', 'r', 'e', 's', 'e', 't', ':', ' ', '%', 'l', 'd', '\n', '\x00'})), i, z, y)
		}
		p = libc.Setstate(q)
	}
	...
	for i = int32(0); i < int32(100); i++ {
		if *(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer((*int64)(unsafe.Pointer(&x)))) + uintptr(i)*8)) != func() (_cgo_ret int64) {
			...
			*_cgo_addr = libc.Random()
			...
			common.T_printf((*int8)(unsafe.Pointer(&[114]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'v', 'f', 'c', '/', 'g', 'o', 'p', 'l', 'u', 's', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 'r', 'a', 'n', 'd', 'o', 'm', '.', 'c', ':', '8', '2', ':', ' ', 's', 'r', 'a', 'n', 'd', 'o', 'm', '(', '1', ')', ' ', 'i', 's', ' ', 'n', 'o', 't', ' ', 'd', 'e', 'f', 'a', 'u', 'l', 't', ':', ' ', '(', '%', 'd', ')', ' ', 'd', 'e', 'f', 'a', 'u', 'l', 't', ':', ' ', '%', 'l', 'd', ',', ' ', 's', 'e', 'e', 'd', '1', ':', ' ', '%', 'l', 'd', '\n', '\x00'})), i, *(*int64)(unsafe.Pointer(uintptr(unsafe.Pointer((*int64)(unsafe.Pointer(&x)))) + uintptr(i)*8)), y)
		}
	}
