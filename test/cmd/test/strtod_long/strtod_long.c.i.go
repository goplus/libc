	...
	*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&buf)))) + uintptr(39999))) = int8(0)
	if func() (_cgo_ret float64) {
		...
		*_cgo_addr = libc.Strtod((*int8)(unsafe.Pointer(&buf)), nil)
		...
		common.T_printf((*int8)(unsafe.Pointer(&[95]int8{'/', 'U', 's', 'e', 'r', 's', '/', 'v', 'f', 'c', '/', 'g', 'o', 'p', 'l', 'u', 's', '/', 'l', 'i', 'b', 'c', '/', 't', 'e', 's', 't', '/', 's', 'r', 'c', '/', 'f', 'u', 'n', 'c', 't', 'i', 'o', 'n', 'a', 'l', '/', 's', 't', 'r', 't', 'o', 'd', '_', 'l', 'o', 'n', 'g', '.', 'c', ':', '1', '6', ':', ' ', 's', 't', 'r', 't', 'o', 'd', '(', '.', '1', '1', '[', '.', '.', '.', ']', '1', ')', ' ', 'g', 'o', 't', ' ', '%', 'a', ' ', 'w', 'a', 'n', 't', ' ', '%', 'a', '\n', '\x00'})), x, want)
	}
