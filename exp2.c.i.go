...
func specialcase_cgos__exp2(tmp float64, sbits uint64, ki uint64) float64 {
	var scale float64
	var y float64
...
func top12_cgos__exp2(x float64) uint32 {
...
func Exp2(x float64) float64 {
	...
	var tail float64
	var tmp float64
	abstop = top12_cgos__exp2(x) & uint32(2047)
	if func() int64 {
		if abstop-top12_cgos__exp2(5.5511151231257827e-17) >= top12_cgos__exp2(512)-top12_cgos__exp2(5.5511151231257827e-17) {
			return 1
		} else {
			return 0
		}
	}() == int64(0) {
		if abstop-top12_cgos__exp2(5.5511151231257827e-17) >= uint32(2147483648) {
			return func() float64 {
				if int32(1) != 0 {
					return 1 + x
				} else {
	...
	if func() int64 {
		...
		return specialcase_cgos__exp2(tmp, sbits, ki)
	}
