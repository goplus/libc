...
var _cgos_t1pio2_tanf float64 = float64(int32(1)) * 1.5707963267948966
var _cgos_t2pio2_tanf float64 = float64(int32(2)) * 1.5707963267948966
var _cgos_t3pio2_tanf float64 = float64(int32(3)) * 1.5707963267948966
var _cgos_t4pio2_tanf float64 = float64(int32(4)) * 1.5707963267948966
...
func Tanf(x float32) float32 {
	...
	if ix <= uint32(1081824209) {
		if ix <= uint32(1075235811) {
			return __tandf(func() float64 {
				if sign != 0 {
					return float64(x) + _cgos_t1pio2_tanf
				} else {
					return float64(x) - _cgos_t1pio2_tanf
				}
			}(), int32(1))
			...
			return __tandf(func() float64 {
				if sign != 0 {
					return float64(x) + _cgos_t2pio2_tanf
				} else {
					return float64(x) - _cgos_t2pio2_tanf
				}
			}(), int32(0))
	...
	if ix <= uint32(1088565717) {
		if ix <= uint32(1085271519) {
			return __tandf(func() float64 {
				if sign != 0 {
					return float64(x) + _cgos_t3pio2_tanf
				} else {
					return float64(x) - _cgos_t3pio2_tanf
				}
			}(), int32(1))
			...
			return __tandf(func() float64 {
				if sign != 0 {
					return float64(x) + _cgos_t4pio2_tanf
				} else {
					return float64(x) - _cgos_t4pio2_tanf
				}
			}(), int32(0))
