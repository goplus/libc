...
func wctype(s *int8) uint64 {
	...
	for func() *int8 {
		...
		return func() (_cgo_ret *int8) {
			_cgo_addr := &p
			*_cgo_addr = (*int8)(unsafe.Pointer(&_cgos_names__iswctype))
			return *_cgo_addr
		}()
	}(); *p != 0; func() *int8 {
		i++
...
var _cgos_names__iswctype [73]int8 = [73]int8{'a', 'l', 'n', 'u', 'm', '\x00', 'a', 'l', 'p', 'h', 'a', '\x00', 'b', 'l', 'a', 'n', 'k', '\x00', 'c', 'n', 't', 'r', 'l', '\x00', 'd', 'i', 'g', 'i', 't', '\x00', 'g', 'r', 'a', 'p', 'h', '\x00', 'l', 'o', 'w', 'e', 'r', '\x00', 'p', 'r', 'i', 'n', 't', '\x00', 'p', 'u', 'n', 'c', 't', '\x00', 's', 'p', 'a', 'c', 'e', '\x00', 'u', 'p', 'p', 'e', 'r', '\x00', 'x', 'd', 'i', 'g', 'i', 't', '\x00'}
