...
func _cgos_scanexp__floatscan(f *struct__IO_FILE, pok int32) int64 {
	var c int32
	var x int32
	var y int64
...
func _cgos_decfloat__floatscan(f *struct__IO_FILE, c int32, bits int32, emin int32, sign int32, pok int32) float64 {
	var x [128]uint32
	var i int32
	var j int32
	var k int32
	...
	*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(int32(0))*4)) = uint32(0)
	...
	if gotdig != 0 && c|int32(32) == 'e' {
		e10 = _cgos_scanexp__floatscan(f, pok)
	...
	if lnz < int32(9) && lnz <= rp && rp < int32(18) {
		...
		if rp < int32(9) {
			return float64(sign) * float64(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(int32(0))*4))) / float64(*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(&_cgos_p10s__floatscan)))) + uintptr(int32(8)-rp)*4)))
		}
		...
		if bitlim > int32(30) || *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(int32(0))*4))>>bitlim == uint32(0) {
			return float64(sign) * float64(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(int32(0))*4))) * float64(*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(&_cgos_p10s__floatscan)))) + uintptr(rp-int32(10))*4)))
		}
	}
	...
	if rp%int32(9) != 0 {
		...
		var p10 int32 = *(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(&_cgos_p10s__floatscan)))) + uintptr(int32(8)-rpm9)*4))
	...
	for rp < 18 || rp == 18 && *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(a)*4)) < *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&_cgos_th__floatscan)))) + uintptr(int32(0))*4)) {
		var carry uint32 = uint32(0)
		e2 -= int32(29)
	...
	for {
		...
		for i = int32(0); i < int32(2); i++ {
			k = (a + i) & 127
			if k == z || *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(k)*4)) < *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&_cgos_th__floatscan)))) + uintptr(i)*4)) {
				i = int32(2)
				break
			}
			if *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr((a+i)&127)*4)) > *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&_cgos_th__floatscan)))) + uintptr(i)*4)) {
				break
			}
		}
		if i == int32(2) && rp == 18 {
...
var _cgos_th__floatscan [2]uint32 = [2]uint32{uint32(9007199), uint32(254740991)}
var _cgos_p10s__floatscan [8]int32 = [8]int32{int32(10), int32(100), int32(1000), int32(10000), int32(100000), int32(1000000), int32(10000000), int32(100000000)}

func _cgos_hexfloat__floatscan(f *struct__IO_FILE, bits int32, emin int32, sign int32, pok int32) float64 {
	...
	if c|int32(32) == 'p' {
		e2 = _cgos_scanexp__floatscan(f, pok)
...
func __floatscan(f *struct__IO_FILE, prec int32, pok int32) float64 {
	...
	if c == '0' {
		...
		if c|int32(32) == 'x' {
			return _cgos_hexfloat__floatscan(f, bits, emin, sign, pok)
		}
		if f.shlim >= int64(0) {
			func() int {
				_ = func() (_cgo_ret *uint8) {
	...
	return _cgos_decfloat__floatscan(f, c, bits, emin, sign, pok)
}
