...
func scanexp_floatscan(f *struct__IO_FILE, pok int32) int64 {
	var c int32
	var x int32
	var y int64
...
func decfloat_floatscan(f *struct__IO_FILE, c int32, bits int32, emin int32, sign int32, pok int32) float64 {
	var x [128]uint32
	var i int32
	var j int32
	var k int32
	...
	*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(int32(0))*4)) = uint32(0)
	...
	if lnz < int32(9) && lnz <= rp && rp < int32(18) {
		...
		if rp < int32(9) {
			return float64(sign) * float64(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(int32(0))*4))) / float64(*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(&p10s_floatscan)))) + uintptr(int32(8)-rp)*4)))
		}
		...
		if bitlim > int32(30) || *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(int32(0))*4))>>bitlim == uint32(0) {
			return float64(sign) * float64(*(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(int32(0))*4))) * float64(*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(&p10s_floatscan)))) + uintptr(rp-int32(10))*4)))
		}
	}
	...
	if rp%int32(9) != 0 {
		...
		var p10 int32 = *(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(&p10s_floatscan)))) + uintptr(int32(8)-rpm9)*4))
	...
	for rp < 18 || rp == 18 && *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(a)*4)) < *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&th_floatscan)))) + uintptr(int32(0))*4)) {
		var carry uint32 = uint32(0)
		e2 -= int32(29)
	...
	for {
		...
		for i = int32(0); i < int32(2); i++ {
			k = (a + i) & 127
			if k == z || *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr(k)*4)) < *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&th_floatscan)))) + uintptr(i)*4)) {
				i = int32(2)
				break
			}
			if *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&x)))) + uintptr((a+i)&127)*4)) > *(*uint32)(unsafe.Pointer(uintptr(unsafe.Pointer((*uint32)(unsafe.Pointer(&th_floatscan)))) + uintptr(i)*4)) {
				break
			}
		}
		if i == int32(2) && rp == 18 {
...
var th_floatscan [2]uint32 = [2]uint32{uint32(9007199), uint32(254740991)}
var p10s_floatscan [8]int32 = [8]int32{int32(10), int32(100), int32(1000), int32(10000), int32(100000), int32(1000000), int32(10000000), int32(100000000)}

func hexfloat_floatscan(f *struct__IO_FILE, bits int32, emin int32, sign int32, pok int32) float64 {
...
func __floatscan(f *struct__IO_FILE, prec int32, pok int32) float64 {
	...
	if c == '0' {
		...
		if c|int32(32) == 'x' {
			return hexfloat_floatscan(f, bits, emin, sign, pok)
		}
		if f.shlim >= int64(0) {
			func() int {
				_ = func() (_cgo_ret *uint8) {
	...
	return decfloat_floatscan(f, c, bits, emin, sign, pok)
}
