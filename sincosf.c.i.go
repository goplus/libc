...
var s1pio2_cgos__sincosf float64 = float64(int32(1)) * 1.5707963267948966
var s2pio2_cgos__sincosf float64 = float64(int32(2)) * 1.5707963267948966
var s3pio2_cgos__sincosf float64 = float64(int32(3)) * 1.5707963267948966
var s4pio2_cgos__sincosf float64 = float64(int32(4)) * 1.5707963267948966
...
func Sincosf(x float32, sin *float32, cos *float32) {
	...
	if ix <= uint32(1081824209) {
		if ix <= uint32(1075235811) {
			if sign != 0 {
				*sin = -__cosdf(float64(x) + s1pio2_cgos__sincosf)
				*cos = __sindf(float64(x) + s1pio2_cgos__sincosf)
			} else {
				*sin = __cosdf(s1pio2_cgos__sincosf - float64(x))
				*cos = __sindf(s1pio2_cgos__sincosf - float64(x))
			}
			return
		}
		*sin = -__sindf(func() float64 {
			if sign != 0 {
				return float64(x) + s2pio2_cgos__sincosf
			} else {
				return float64(x) - s2pio2_cgos__sincosf
			}
		}())
	...
	if ix <= uint32(1088565717) {
		if ix <= uint32(1085271519) {
			if sign != 0 {
				*sin = __cosdf(float64(x) + s3pio2_cgos__sincosf)
				*cos = -__sindf(float64(x) + s3pio2_cgos__sincosf)
			} else {
				*sin = -__cosdf(float64(x) - s3pio2_cgos__sincosf)
				*cos = __sindf(float64(x) - s3pio2_cgos__sincosf)
			}
		...
		*sin = __sindf(func() float64 {
			if sign != 0 {
				return float64(x) + s4pio2_cgos__sincosf
			} else {
				return float64(x) - s4pio2_cgos__sincosf
			}
		}())
