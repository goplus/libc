...
var dummy_file_cgo539 *struct__IO_FILE = nil

func close_file_cgo540(f *struct__IO_FILE) {
	if !(f != nil) {
		return
	}
	func() int32 {
...
func __stdio_exit() {
	...
	close_file_cgo540(__stdin_used)
	close_file_cgo540(__stdout_used)
	close_file_cgo540(__stderr_used)
}
