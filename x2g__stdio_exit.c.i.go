...
var dummy_file_cgo861 *struct__IO_FILE = nil

func close_file_cgo862(f *struct__IO_FILE) {
	if !(f != nil) {
		return
	}
	func() int32 {
...
func __stdio_exit() {
	...
	close_file_cgo862(__stdin_used)
	close_file_cgo862(__stdout_used)
	close_file_cgo862(__stderr_used)
}
