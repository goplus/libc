...
var dummy_file_cgo1008 *struct__IO_FILE = nil

func close_file_cgo1009(f *struct__IO_FILE) {
	if !(f != nil) {
		return
	}
	func() int32 {
...
func __stdio_exit() {
	...
	for f = *__ofl_lock(); f != nil; f = f.next {
		close_file_cgo1009(f)
	}
	close_file_cgo1009(__stdin_used)
	close_file_cgo1009(__stdout_used)
	close_file_cgo1009(__stderr_used)
}
