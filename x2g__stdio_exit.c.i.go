...
var dummy_file_cgo890 *struct__IO_FILE = nil

func close_file_cgo891(f *struct__IO_FILE) {
	if !(f != nil) {
		return
	}
	func() int32 {
...
func __stdio_exit() {
	...
	close_file_cgo891(__stdin_used)
	close_file_cgo891(__stdout_used)
	close_file_cgo891(__stderr_used)
}
