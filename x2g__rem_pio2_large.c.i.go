...
func __rem_pio2_large(x *float64, y *float64, e0 int32, nx int32, prec int32) int32 {
	...
	var fq [20]float64
	var q [20]float64
	jk = *(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(&_cgos_init_jk___rem_pio2_large)))) + uintptr(prec)*4))
	jp = jk
	jx = nx - int32(1)
...
recompute:
	...
	if z == 0 {
		...
		if j == int32(0) {
			...
			for i = jz + int32(1); i <= jz+k; i++ {
				*(*float64)(unsafe.Pointer(uintptr(unsafe.Pointer((*float64)(unsafe.Pointer(&f)))) + uintptr(jx+i)*8)) = float64(*(*int32)(unsafe.Pointer(uintptr(unsafe.Pointer((*int32)(unsafe.Pointer(&_cgos_ipio2___rem_pio2_large)))) + uintptr(jv+i)*4)))
				for func() float64 {
					j = int32(0)
					return func() (_cgo_ret float64) {
						_cgo_addr := &fw
	...
	for i = jz; i >= int32(0); i-- {
		for func() int32 {
			...
			fw += *(*float64)(unsafe.Pointer(uintptr(unsafe.Pointer((*float64)(unsafe.Pointer(&_cgos_PIo2___rem_pio2_large)))) + uintptr(k)*8)) * *(*float64)(unsafe.Pointer(uintptr(unsafe.Pointer((*float64)(unsafe.Pointer(&q)))) + uintptr(i+k)*8))
		}
