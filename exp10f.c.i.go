...
func Exp10f(x float32) float32 {
	...
	if *(*uint32)(unsafe.Pointer(&u))>>int32(23)&uint32(255) < uint32(130) {
		if !(y != 0) {
			return *(*float32)(unsafe.Pointer(uintptr(unsafe.Pointer((*float32)(unsafe.Pointer(&_cgos_p10_exp10f)))) + uintptr(int32(n)+int32(7))*4))
		}
		y = Exp2f(3.32192802 * y)
		return y * *(*float32)(unsafe.Pointer(uintptr(unsafe.Pointer((*float32)(unsafe.Pointer(&_cgos_p10_exp10f)))) + uintptr(int32(n)+int32(7))*4))
	}
