...
type Pthread_spinlock_t = int32
type _cgoa_1___cos struct {
	__attr uint32
}
type pthread_mutexattr_t = _cgoa_1___cos
type Pthread_mutexattr_t = _cgoa_1___cos
type _cgoa_2___cos struct {
	__attr uint32
}
type pthread_condattr_t = _cgoa_2___cos
type Pthread_condattr_t = _cgoa_2___cos
type _cgoa_3___cos struct {
	__attr uint32
}
type pthread_barrierattr_t = _cgoa_3___cos
type Pthread_barrierattr_t = _cgoa_3___cos
type _cgoa_4___cos struct {
	__attr [2]uint32
}
type pthread_rwlockattr_t = _cgoa_4___cos
type Pthread_rwlockattr_t = _cgoa_4___cos
...
type Sigset_t = struct___sigset_t
type _cgoa_6___cos struct {
	__i [14]int32
}
type _cgoa_5___cos struct {
	__u _cgoa_6___cos
}
type pthread_attr_t = _cgoa_5___cos
type Pthread_attr_t = _cgoa_5___cos
type _cgoa_8___cos struct {
	__i [10]int32
}
type _cgoa_7___cos struct {
	__u _cgoa_8___cos
}
type pthread_mutex_t = _cgoa_7___cos
type Pthread_mutex_t = _cgoa_7___cos
type _cgoa_10___cos struct {
	__i [12]int32
}
type _cgoa_9___cos struct {
	__u _cgoa_10___cos
}
type pthread_cond_t = _cgoa_9___cos
type Pthread_cond_t = _cgoa_9___cos
type _cgoa_12___cos struct {
	__i [14]int32
}
type _cgoa_11___cos struct {
	__u _cgoa_12___cos
}
type pthread_rwlock_t = _cgoa_11___cos
type Pthread_rwlock_t = _cgoa_11___cos
type _cgoa_14___cos struct {
	__i [8]int32
}
type _cgoa_13___cos struct {
	__u _cgoa_14___cos
}
type pthread_barrier_t = _cgoa_13___cos
type Pthread_barrier_t = _cgoa_13___cos
type pid_t = int32
type Pid_t = int32
...
type wchar_t = uint32
type Wchar_t = uint32
type _cgoa_15___cos struct {
	quot int32
	rem  int32
}
type div_t = _cgoa_15___cos
type Div_t = _cgoa_15___cos
type _cgoa_16___cos struct {
	quot int64
	rem  int64
}
type ldiv_t = _cgoa_16___cos
type Ldiv_t = _cgoa_16___cos
type _cgoa_17___cos struct {
	quot int64
	rem  int64
}
type lldiv_t = _cgoa_17___cos
type Lldiv_t = _cgoa_17___cos
type ssize_t = int64
type Ssize_t = int64
type off_t = int64
...
func a_ctz_32(x uint32) int32 {
	return int32(*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&_cgos_debruijn32__fma)))) + uintptr(x&-x*uint32(124511785)>>int32(27)))))
}

var _cgos_debruijn32__fma [32]int8 = [32]int8{int8(0), int8(1), int8(23), int8(2), int8(29), int8(24), int8(19), int8(3), int8(30), int8(27), int8(25), int8(11), int8(20), int8(8), int8(4), int8(13), int8(31), int8(22), int8(28), int8(18), int8(26), int8(10), int8(7), int8(12), int8(21), int8(17), int8(9), int8(6), int8(16), int8(5), int8(15), int8(14)}
...
type Mbstate_t = struct___mbstate_t
type _cgoa_18_fmemopen struct {
	__ll int64
	__ld float64
}
type max_align_t = _cgoa_18_fmemopen
type Max_align_t = _cgoa_18_fmemopen
...
type struct_stat struct {
	...
	st_blksize         int64
	st_blocks          int64
	__st_atim32        _cgoa_18_tempnam
	__st_mtim32        _cgoa_18_tempnam
	__st_ctim32        _cgoa_18_tempnam
	st_ino             uint64
...
type _cgoa_30_strsignal struct {
	...
	sigev_notify_attributes *_cgoa_5___cos
}
