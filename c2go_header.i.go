...
type Pthread_spinlock_t = int32
type _cgoa_1___fclose_ca struct {
	__attr uint32
}
type pthread_mutexattr_t = _cgoa_1___fclose_ca
type Pthread_mutexattr_t = _cgoa_1___fclose_ca
type _cgoa_2___fclose_ca struct {
	__attr uint32
}
type pthread_condattr_t = _cgoa_2___fclose_ca
type Pthread_condattr_t = _cgoa_2___fclose_ca
type _cgoa_3___fclose_ca struct {
	__attr uint32
}
type pthread_barrierattr_t = _cgoa_3___fclose_ca
type Pthread_barrierattr_t = _cgoa_3___fclose_ca
type _cgoa_4___fclose_ca struct {
	__attr [2]uint32
}
...
type Sigset_t = struct___sigset_t
type _cgoa_6___fclose_ca struct {
	__i [14]int32
}
type _cgoa_5___fclose_ca struct {
	__u _cgoa_6___fclose_ca
}
type pthread_attr_t = _cgoa_5___fclose_ca
type Pthread_attr_t = _cgoa_5___fclose_ca
type _cgoa_8___fclose_ca struct {
	__i [10]int32
}
type _cgoa_7___fclose_ca struct {
	__u _cgoa_8___fclose_ca
}
type pthread_mutex_t = _cgoa_7___fclose_ca
type Pthread_mutex_t = _cgoa_7___fclose_ca
type _cgoa_10___fclose_ca struct {
	__i [12]int32
}
type _cgoa_9___fclose_ca struct {
	__u _cgoa_10___fclose_ca
}
type pthread_cond_t = _cgoa_9___fclose_ca
type Pthread_cond_t = _cgoa_9___fclose_ca
type _cgoa_12___fclose_ca struct {
	__i [14]int32
}
type _cgoa_11___fclose_ca struct {
	__u _cgoa_12___fclose_ca
}
type pthread_rwlock_t = _cgoa_11___fclose_ca
type Pthread_rwlock_t = _cgoa_11___fclose_ca
type _cgoa_14___fclose_ca struct {
	__i [8]int32
}
type _cgoa_13___fclose_ca struct {
	__u _cgoa_14___fclose_ca
}
type pthread_barrier_t = _cgoa_13___fclose_ca
type Pthread_barrier_t = _cgoa_13___fclose_ca
type pid_t = int32
type Pid_t = int32
...
type wchar_t = uint32
type Wchar_t = uint32
type _cgoa_15___fclose_ca struct {
	quot int32
	rem  int32
}
type div_t = _cgoa_15___fclose_ca
type Div_t = _cgoa_15___fclose_ca
type _cgoa_16___fclose_ca struct {
	quot int64
	rem  int64
}
type ldiv_t = _cgoa_16___fclose_ca
type Ldiv_t = _cgoa_16___fclose_ca
type _cgoa_17___fclose_ca struct {
	quot int64
	rem  int64
}
type lldiv_t = _cgoa_17___fclose_ca
type Lldiv_t = _cgoa_17___fclose_ca
type ssize_t = int64
type Ssize_t = int64
type off_t = int64
...
func X__FLOAT_BITS(__f float32) uint32 {
	type _cgoa_20_vfprintf struct {
		__f float32
	}
	var __u _cgoa_20_vfprintf
	__u.__f = __f
	return *(*uint32)(unsafe.Pointer(&__u))
}
func X__DOUBLE_BITS(__f float64) uint64 {
	type _cgoa_21_vfprintf struct {
		__f float64
	}
	var __u _cgoa_21_vfprintf
	__u.__f = __f
...
func a_ctz_32(x uint32) int32 {
	return int32(*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&debruijn32_cgo20_fma)))) + uintptr(x&-x*uint32(124511785)>>int32(27)))))
}

var debruijn32_cgo20_fma [32]int8 = [32]int8{int8(0), int8(1), int8(23), int8(2), int8(29), int8(24), int8(19), int8(3), int8(30), int8(27), int8(25), int8(11), int8(20), int8(8), int8(4), int8(13), int8(31), int8(22), int8(28), int8(18), int8(26), int8(10), int8(7), int8(12), int8(21), int8(17), int8(9), int8(6), int8(16), int8(5), int8(15), int8(14)}
...
type _cgoa_30_strsignal struct {
	...
	sigev_notify_attributes *_cgoa_5___fclose_ca
}
