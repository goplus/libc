...
func a_ctz_32(x uint32) int32 {
	return int32(*(*int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*int8)(unsafe.Pointer(&debruijn32_cgo695)))) + uintptr(x&-x*uint32(124511785)>>int32(27)))))
}

var debruijn32_cgo695 [32]int8 = [32]int8{int8(0), int8(1), int8(23), int8(2), int8(29), int8(24), int8(19), int8(3), int8(30), int8(27), int8(25), int8(11), int8(20), int8(8), int8(4), int8(13), int8(31), int8(22), int8(28), int8(18), int8(26), int8(10), int8(7), int8(12), int8(21), int8(17), int8(9), int8(6), int8(16), int8(5), int8(15), int8(14)}
...
type struct_stat struct {
	...
	st_blksize         int64
	st_blocks          int64
	__st_atim32        _cgoa_778
	__st_mtim32        _cgoa_778
	__st_ctim32        _cgoa_778
	st_ino             uint64
...
type Mbstate_t = struct___mbstate_t
type _cgoa_1142 struct {
	quot int64
	rem  int64
}
type imaxdiv_t = _cgoa_1142
